...
import vista.inter_facturacion;
...
public class VentaPDF {
    ...
    public void DatosCliente(int idCliente) {
        ...
        String sql = "select * from t_cliente where id_cliente = '" + idCliente + "'";
        Statement st;
        try {
    ...
    public void generarFacturaPDF() {
        try {
            ...
            String nombre = "Papy Wylo";
            String telefono = "0987654321";
            String direccion = "baby quilla";
            String razon = "gracias por su compra, lo esperamos ver nuevamente";
            ...
            for(int i = 0; i < inter_facturacion.tabla_productos.getRowCount(); i++){
                String producto = inter_facturacion.tabla_productos.getValueAt(i, 1).toString();
                String cantidad = inter_facturacion.tabla_productos.getValueAt(i, 2).toString();
                String precio = inter_facturacion.tabla_productos.getValueAt(i, 3).toString();
                String total = inter_facturacion.tabla_productos.getValueAt(i, 7).toString();
            ...
            info.add("Total a pagar: " + inter_facturacion.txttotala_ppagar.getText());
           ...
           firma.add("____________________________________");
